...
interface SavedRundownReadOnlyViewProps {
  selectedRundown: SavedRundown;
  onClose: () => void;
}

export const SavedRundownReadOnlyView = ({ selectedRundown, onClose }: SavedRundownReadOnlyViewProps) => {
    ...
    <>
      <div className="bg-gray-200 p-2 -mt-4 -mx-4 mb-4 flex justify-between items-center">
        <span className="font-medium text-gray-700">
          Espelho salvo em modo de leitura - {selectedRundown.nome} - {selectedRundown.data_referencia.toLocaleDateString('pt-BR')}
        </span>
      ...
      <div className="overflow-auto flex-grow">
        {selectedRundown.estrutura.blocks.length > 0 ? (
          <div className="space-y-6">
            <h3 className="font-medium mb-2">Blocos</h3>
            {selectedRundown.estrutura.blocks.map((block) => (
