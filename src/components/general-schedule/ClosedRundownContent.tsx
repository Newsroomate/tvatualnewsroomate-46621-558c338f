              ...
              <CardContent className="pt-0">
                <div className="space-y-4">
                  {blocos.map((bloco, blocoIndex) => {
                    ...
                    return (
                      <div key={bloco.id || `bloco-${blocoIndex}`} className="border rounded-lg p-3 bg-gray-50">
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center space-x-2">
                            <Button
                              variant="ghost"
                              size="sm"
                              onClick={() => toggleBlockExpansion(bloco.id || `bloco-${blocoIndex}`)}
                          ...
                          <div className="space-y-2 ml-6">
                            {materias.length > 0 ? (
                              materias.map((materia: any, materiaIndex: number) => (
                                <div key={materia.id || `materia-${materiaIndex}`} className="bg-white border rounded p-3 text-sm">
